                    ...
                    <div className="flex h-16 justify-between">
                                ...
                                <Dropdown>
                                    <Dropdown.Trigger>
                                        <span className="inline-flex rounded-md">
                                            <button
                                                type="button"
                                                className="button-ghost rounded-md px-3 py-2 text-sm font-medium leading-4 text-muted-foreground"
                                            >
                                                {user.name}
                        ...
                        <div className="-me-2 flex items-center sm:hidden">
                            <button
                                ...
                                className="button-ghost rounded-md p-2 text-muted-foreground"
                            >

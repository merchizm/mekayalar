...
const Header = () => {
  ...
  return (
    <header className={`flex fixed ${scrolled ? 'top-2' : 'top-4'} z-50 justify-center px-4 w-full transition-all duration-300`}>
      <div className="relative">
        <nav className={`overflow-hidden rounded-full backdrop-blur-lg bg-background/80 dark:bg-background-dark/80 ${scrolled ? 'ring-1 shadow-lg ring-black/5' : ''}`}>
          <div className="mobile-nav-container">
            <ul className="flex gap-1 items-center p-2 whitespace-nowrap md:justify-center">

...
export const FileIcon = ({ className = 'w-5 h-5' }) => (
    <svg className={`${className} text-muted-foreground`} fill="currentColor" viewBox="0 0 20 20">
        <path
            fillRule="evenodd"
...
export const ImageIcon = ({ className = 'w-5 h-5' }) => (
    <svg className={`${className} text-primary`} fill="currentColor" viewBox="0 0 20 20">
        <path
            fillRule="evenodd"
...
export const VideoIcon = ({ className = 'w-5 h-5' }) => (
    <svg className={`${className} text-destructive`} fill="currentColor" viewBox="0 0 20 20">
        <path d="M2 6a2 2 0 012-2h6a2 2 0 012 2v8a2 2 0 01-2 2H4a2 2 0 01-2-2V6zM14.553 7.106A1 1 0 0014 8v4a1 1 0 00.553.894l2 1A1 1 0 0018 13V7a1 1 0 00-1.447-.894l-2 1z" />
    </svg>
);

export const AudioIcon = ({ className = 'w-5 h-5' }) => (
    <svg className={`${className} text-success`} fill="currentColor" viewBox="0 0 20 20">

...
const ToolbarButton = ({ onClick, title, icon }) => (
    <button
        type="button"
        onClick={onClick}
        className="rounded-md border border-gray-300 bg-gray-100 px-2 py-1 text-gray-600 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-1 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 dark:hover:bg-gray-600"
        title={title}
    >
        {iconMap[icon]}
    </button>

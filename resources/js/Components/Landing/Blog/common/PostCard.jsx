...
const PostCard = ({ post }) => (
    <Link href={route('blog.show', { slug: post.post_slug })} className="group mx-auto block w-full max-w-4xl">
        <div className="surface-lift rounded-[2rem] border border-border/70 bg-background/55 p-5 shadow-sm transition-all duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] dark:border-border dark:bg-card/55">
            <div className="grid grid-cols-1 items-center gap-8 md:grid-cols-5">
                ...
                <div className={post.post_image ? 'md:col-span-3' : 'md:col-span-5'}>
                    <h2 className="mb-2 text-3xl font-bold text-foreground transition duration-300 group-hover:translate-x-1 group-hover:text-primary dark:text-foreground dark:group-hover:text-primary">
                        {post.post_title}
                    </h2>
                    ...
                    <p className="line-clamp-3 leading-relaxed text-muted-foreground dark:text-muted-foreground">

...
const Breadcrumb = ({ post }) => (
  <nav aria-label="breadcrumb" className="mb-6">
    <ol className="flex text-sm text-light-text dark:text-light-text-dark">
      ...
      <li className="breadcrumb-item"><Link href={route('blog.index')} className="transition-colors hover:text-menu-active dark:hover:text-menu-active-dark">Yazılar</Link></li>
      <li className="mx-2">/</li>

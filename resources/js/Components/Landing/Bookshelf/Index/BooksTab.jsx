...
const BooksTab = () => (
  <div>
    <div className="py-24 my-5 text-center rounded-2xl border-2 border-dashed bg-background dark:bg-repository-card-bg-dark border-divider dark:border-divider-dark">
      ...
      <h2 className="mb-3 text-3xl font-bold text-text dark:text-text-dark">{__('Çok Yakında')}</h2>
      <p className="text-xl text-center text-light-text dark:text-light-text-dark">{__('Okuduğum kitapları burada sergilemek için sabırsızlanıyorum.')}</p>
    </div>
  </div>
);

                    ...
                    <div className="relative w-full max-w-lg rounded-3xl border border-divider bg-background p-5 shadow-2xl dark:border-label-border-dark dark:bg-repository-card-bg-dark">
                        <div className="flex items-center justify-between">
                            ...
                            <button
                                type="button"
                                onClick={() => setPreviewId(null)}
                                className="rounded-full border border-divider bg-background p-2 text-xs text-text shadow-sm transition hover:bg-button-hover dark:border-divider-dark dark:bg-repository-card-bg-dark dark:text-text-dark dark:hover:bg-button-hover-dark"
                            >
                                ✕
                            </button>
                        </div>
                        <div className="mt-4 space-y-2">
                            {isLoading && (
                                <div className="text-center text-xs text-light-text dark:text-light-text-dark">
                                    {__('Yükleniyor...')}
                                </div>
                            )}
                            ...
                            {!isLoading &&
                                activeTracks.map((track) => (
                                    <div
                                        ...
                                        className="flex items-center gap-3 rounded-2xl border border-divider bg-background p-2 shadow-sm dark:border-divider-dark dark:bg-repository-card-bg-dark"
                                    >
                                        {track.image ? (
                                            <img
                                                src={track.image}
                        ...
                        <div className="mt-4 flex justify-end">
                            <a
                                ...
                                className="inline-flex items-center rounded-full bg-menu-active px-4 py-2 text-xs font-semibold text-white shadow-sm transition hover:opacity-90 dark:bg-menu-active-dark dark:text-text-dark"
                            >
                                {__('Spotify’da Aç')}
                            </a>
                        </div>

        ...
        <>
            {project.image ? (
                ...
                <header className="mb-10 text-center">
                    <h1 className="mb-4 text-4xl font-extrabold tracking-tight text-text dark:text-text-dark md:text-5xl">
                        {project.title}
                    </h1>
                    {project.completed_at && (
                        <div className="flex items-center justify-center text-light-text dark:text-light-text-dark">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                className="mr-2 h-5 w-5"
                                fill="none"

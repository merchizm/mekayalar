...
const DayIcon = () => (
  <svg viewBox="0 0 24 24" width="20" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="flex relative justify-between items-end w-full max-w-2xl h-16" ref={ticksContainerRef} onMouseLeave={handleMouseLeave}>
        {hours.map((hour, index) => {
          ...
          return (
            <div key={hour}
              data-hour={hour}
              className={`h-full flex justify-center items-end px-2 ${hour === actualHour ? 'cursor-default' : 'cursor-pointer'}`}

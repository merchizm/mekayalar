...
export default function DarkModeToggle({ isDarkMode, toggleMode, hasManualOverride, resetToAutomatic }) {
    const lightSvg = (
        <svg viewBox="0 0 24 24" width="20" fill="#d7d7db" xmlns="http://www.w3.org/2000/svg">
    ...
    const darkSvg = (
        <svg viewBox="0 0 24 24" width="20" fill="#24292e" xmlns="http://www.w3.org/2000/svg">
            <g>
                {' '}
                <path
            ...
            <button
                ...
                title={
                    hasManualOverride
                        ...
                        : __('Zamana dayalı otomatik mod etkin')
                }
            >

      ...
      <div className="mx-auto max-w-3xl">
        <nav aria-label="breadcrumb" className="mb-8">
          <ol className="flex text-sm text-light-text dark:text-light-text-dark">
            ...
            <li className="breadcrumb-item"><Link href={route('poems.index')} className="transition-colors hover:text-menu-active dark:hover:text-menu-active-dark">{__('Şiirler')}</Link></li>
            <li className="mx-2">/</li>
        ...
        <article>
          ...
          <footer className="flex flex-col items-center mt-12 text-center">
            <p className="mb-4 text-lg text-light-text dark:text-light-text-dark">{__('Bu şiiri okurken keyif aldınız mı?')}</p>
            <applause-button
              id={poem.id}
              type="poem"
              multiclap="true"

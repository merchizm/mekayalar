  ...
  return (
    <>
      <div className="flex items-center p-5 mb-8 rounded-xl border bg-background dark:bg-repository-card-bg-dark border-divider dark:border-label-border-dark">
        ...
        <div>
          <p className="text-base text-text dark:text-text-dark">{__('Web siteyi hala geliştirme aşamasındayım. Bu sebeple bazı hatalarla karşılaşabilirsiniz.')}</p>
        </div>
      </div>

      <div className="leading-relaxed">
        <h1 className="flex items-center mb-8 text-4xl font-bold tracking-tight sm:text-5xl">
          {__('hey, Ben Meriç')} <span className="ml-3 wave">👋</span>
        </h1>
          ...
          <p className="mb-4 text-base sm:text-lg text-text dark:text-text-dark">
            <Trans
              ...
              components={{
                ...
                laravel: <span className="label"><span><Laravel /></span>Laravel</span>
              }}
            />
          </p>
        </div>
        ...
        <div className="mb-12">
          ...
          <div className="space-y-4">
            ...
            <div className="p-4 rounded-lg border transition-all duration-300 border-divider dark:border-label-border-dark bg-background dark:bg-repository-card-bg-dark">
              <div className="flex gap-4 items-start">
                ...
                <div className="flex-grow">
                  ...
                  <p className="text-sm text-light-text dark:text-light-text-dark">{__('Aralık 2023 - Kasım 2024')}</p>
                </div>
              </div>
            </div>
            ...
            <AccordionItem
              ...
              {__('Bir şirketin tam olarak nasıl sorunsuz bir şekilde işlemesi için gereken donanımları, çalışanların isimleriyle LDAP ağına nasıl bağlı olduklarını ve bu ağa nasıl giriş yaptıklarını, kayıtlarını nasıl oluşturduğumuzu tecrübe ettim. Bunun yanı sıra Bilgisayar Donanımlarıyla ilişkimi kuvvetlendirerek cihazların yanıtlarına göre hangi donanımın sıkıntılı olduğunu çözebilecek konuma geldim. Bir IT Çalışanının rutin olarak neleri kontrol ettiğini ve problemleri hangi prensipler ile çözdüklerini, görev yönetimini nasıl gerçekleştirdiklerini ve gelişimi nasıl takip ettiklerini öğrendim.')}
            </AccordionItem>
          </div>
        </div>

        <div className="mb-12">
          <h2 className="mb-6 text-2xl font-bold text-text dark:text-text-dark">{__('Öne Çıkan Yetenekler')}</h2>
          <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
        ...
        {featuredProjects && featuredProjects.length > 0 && (
          <div className="mb-8">
            <h2 className="mb-6 text-2xl font-bold text-text dark:text-text-dark">{__('Öne Çıkan Projeler')}</h2>

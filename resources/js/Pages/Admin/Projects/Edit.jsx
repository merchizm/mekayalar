    ...
    return (
        <AdminLayout user={auth.user}>
            ...
            <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                <div>
                    <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Projeyi Düzenle</h2>
                    <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">{getDisplayTitle(data.title)}</p>
                </div>
                <Link

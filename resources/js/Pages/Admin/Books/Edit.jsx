    ...
    return (
        <AdminLayout user={auth.user}>
            ...
            <form onSubmit={submit} className="space-y-6 rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                <h1 className="text-xl font-semibold text-gray-900 dark:text-white">Kitap Düzenle</h1>
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                    ...
                    <div>
                        <label className={labelClass}>Kapak URL</label>
                    ...
                    <div>
                        <label className={labelClass}>Başlama Tarihi</label>

...
export default function Welcome({ auth, laravelVersion, phpVersion }) {
    ...
    return (
        <>
            <Head title="Welcome" />
            <div className="bg-secondary/70 text-black/50 dark:bg-black dark:text-foreground/50">
                <img
                    id="background"
                    ...
                    <div className="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                            ...
                            <nav className="-mx-3 flex flex-1 justify-end">
                                {auth.user ? (
                                    <Link
                                        ...
                                        className="rounded-md px-3 py-2 text-black ring-1 ring-transparent transition hover:text-black/70 focus:outline-none focus-visible:ring-[#FF2D20] dark:text-foreground dark:hover:text-white/80 dark:focus-visible:ring-white"
                                    >
                                        Dashboard
                                    </Link>
                                ) : (
                        ...
                        <main className="mt-6">
                            <div className="grid gap-6 lg:grid-cols-2 lg:gap-8">
                                ...
                                <div className="flex items-start gap-4 rounded-lg bg-card p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] dark:bg-zinc-900 dark:ring-zinc-800 lg:pb-10">
                                    <div className="flex size-12 shrink-0 items-center justify-center rounded-full bg-[#FF2D20]/10 sm:size-16">
                                        <svg
                                            className="size-5 sm:size-6"
                                            xmlns="http://www.w3.org/2000/svg"

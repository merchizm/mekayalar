...
@section('content')
    <header class="mb-12 text-center">
        <h1 class="text-5xl font-bold tracking-tight text-text dark:text-text-dark">Gönderilerim</h1>
        <p class="mx-auto mt-4 max-w-2xl text-xl text-light-text dark:text-light-text-dark">Düşüncelerim, tecrübelerim ve ara sıra karaladığım çizimler. Burada da çok profesyonel şeyler paylaşmadığımı ve daha kişisel şeyler olduğunu itiraf etmeliyim.</p>
    </header>
    ...
    <div class="space-y-12">
        @forelse ($posts as $post)
            ...
            @else
                <div class="mx-auto max-w-2xl text-center">
                    <a href="{{ $post->post_image }}" data-fslightbox="gallery" class="block group">
        ...
        @empty
            <div class="py-24 my-5 text-center rounded-2xl border-2 border-dashed bg-background dark:bg-repository-card-bg-dark border-divider dark:border-divider-dark">
                ...
                <h2 class="mb-3 text-3xl font-bold text-text dark:text-text-dark">Henüz Gönderi Yok</h2>
                <p class="text-xl text-center text-light-text dark:text-light-text-dark">Burada paylaşacak bir şeyler olduğunda tekrar uğrayın.</p>
            </div>
        @endforelse
    </div>
@endsection
